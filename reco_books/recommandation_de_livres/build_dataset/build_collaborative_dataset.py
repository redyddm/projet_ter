...
def build_collaborative_dataset(books, ratings, authors, min_ratings=0, min_users=0):

    ratings_explicit, _ = preprocess_collaborative(ratings, min_rating_book=min_ratings, min_rating_user=min_users)
